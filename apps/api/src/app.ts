...
import { slackHandler } from "./integrations/slack/slackHandler";
...
export function createApp() {
  ...
  // Integrations (kept for later; not core to dashboard iteration)
  app.post("/integrations/slack/events", slackHandler);
